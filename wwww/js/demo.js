...
function ($rootScope, $location, $cookieStore, $http) {
    ...
    $rootScope.$on('$locationChangeStart', function (event, next, current) {
     ...
     //   aa.indexOf('d')
        debugger
        var restrictedPage = $.inArray(sPath, ['/dashboard','/app/meusJogos','/app/login','/app/bQuadra','/app/fotos','/app/msg','/app/notificacao','/app/horarios','/app/cadastro', '/app/signup','/app/home','/app/dashboard' ,'/home', '/app/scroll', '/app/forms', '/app/toggle', '/app/tabs', '/app/dropdown','/app']) === -1;
